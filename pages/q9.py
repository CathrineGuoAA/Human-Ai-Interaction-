...
def main():
    st.title("Question 9")
    rating = st.slider("How would you rate the lecturers overall effectiveness in presenting the content, engaging students, and being approachable and open to  questions? 5 Scale: Poor to excellent")
