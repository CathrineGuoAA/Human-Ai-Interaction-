...
def main():
    st.title("Question 9")
    rating = st.slider("How would you rate the lecturers overall effectiveness in presenting the content, engaging students, and being approachable and open to  questions? 5 Scale: Poor to excellent", 1, 5)
    ...
    if rating <= 2:
        ...
        st.write(follow_up)
        response = st.text_input("Your answer", key="Q9_follow_up")
